            ...
            <section className="row text-secondary my-3">
                <div className="col-md-4">
                    <h3 className="text-center text-uppercase">
                        {auth.user.role === 'user' ? 'Kullanıcı Profili' : 'Admin Profili'}
                    </h3>
                    ...
                    <div className="form-group">
                        ...
                        placeholder="Yeni Şifre" onChange={handleChange} />
                    </div>

                    <div className="form-group">
                        <label htmlFor="cf_password">Tekrar Yeni Şifre</label>
                        <input type="password" name="cf_password" value={cf_password} className="form-control"
                        placeholder="Tekrar Yeni Şifre" onChange={handleChange} />
                    </div>
